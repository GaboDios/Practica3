...
public class AMDFuenteAlimentacion implements FuenteAlimentacion, Componente {
     ...
     * @param gama La gama de la funete de alimentacion.
     */
    ...
    /**
     * Obtiene una descripcion de la gama de la fuente de alimentacion.
     *
     * @return Una cadena con la descripcion de gama.
     */
    @Override
