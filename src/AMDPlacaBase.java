...
public class AMDPlacaBase implements PlacaBase, Componente {
     ...
     */
    public AMDPlacaBase(String nombre, double precio, String marca, String formato, String chipset, String compatibleSocket) {
        this.nombre = nombre;
        this.precio = precio;
        this.marca = marca;
    ...
    public String getCompatibleSocket() {
        return compatibleSocket;  // Retorna el socket compatible
    }
